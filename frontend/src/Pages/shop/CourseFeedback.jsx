...
function CourseFeedback({ isOpen, onClose }) {
  const [searchParams] = useSearchParams();
  const navigate = useNavigate();
  const businessCategory = searchParams.get("business_category") || searchParams.get("category") || "online_course";
  ...
  const handleInitialSubmit = async () => {
    ...
    try {
      ...
      // Mark as course conversation
      formData.append("conversation_type", "course");
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="course-feedback-popup-overlay"
        onClick={(e) => {
      ...
      >
        <motion.div
          ...
          className="course-feedback-popup-content"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close Button */}
          <button
            className="course-feedback-close-btn"
            onClick={onClose}
          ...
          <div className="rateus-container course-feedback-popup-inner">
        ...
        {/* Header */}
          ...
          >
            ...
            <motion.p
              ...
              className="subtitle"
            >
              Share your learning experience and help us improve our courses
            </motion.p>
          </motion.div>
          ...
          {!isFollowUp && (
              ...
              >
                ...
                How would you rate this course? (0-10)
              </label>
                ...
                >
                  ...
                  >
                    ...
                    <span className="rating-label-title">Poor</span>
                    <p className="rating-label-description">Did not meet expectations</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <span className="rating-label-title">Excellent</span>
                    <p className="rating-label-description">Exceeded expectations</p>
                  </motion.div>
                </motion.div>
              </motion.div>
            )}
                  ...
                  {textInput.trim() && (
                    ...
                    >
                      {loading ? (
                        ...
                        !isFollowUp ? "Submit Course Feedback" : "Send Follow-Up"
                      )}
                    </motion.button>
                  )}
                </motion.div>
